...
final class Version20260416113000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE INDEX IF NOT EXISTS idx_tracked_jobs_company_trgm ON trackers.tracked_jobs '
            .'USING GIN (LOWER(company) gin_trgm_ops)',
        );
        $this->addSql(
            'CREATE INDEX IF NOT EXISTS idx_tracked_jobs_title_trgm ON trackers.tracked_jobs '
