...
final class Version20260414100000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE trackers.tracked_jobs ADD CONSTRAINT fk_tracked_jobs_owner FOREIGN KEY (owner_id) '
            .'REFERENCES trackers.users (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE',
        );
    }
