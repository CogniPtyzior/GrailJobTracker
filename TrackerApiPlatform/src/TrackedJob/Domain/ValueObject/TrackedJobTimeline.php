...
/*
 * Domain value object for tracked job process dates.
 * It owns follow-up date calculation and automatic status inference from the recruitment timeline.
 */
...
{
    private const int FOLLOW_UP_DELAY_DAYS = 15;
