...
/*
 * Application service that applies write commands to tracked job aggregates.
 * It centralizes command-to-domain orchestration so create and update use cases stay consistent.
 */
...
final readonly class TrackedJobCommandApplier
{
