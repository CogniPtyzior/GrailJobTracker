...
/*
 * Doctrine record mapped to the existing trackers.tracked_jobs table.
...
final class TrackedJobRecord
{
    ...
    #[ORM\Column(name: 'contract_type', enumType: ContractType::class, nullable: true)]
    private ?ContractType $contractType = ContractType::CDI;

    #[ORM\Column(length: 255, nullable: true)]
    private ?string $location = null;

    #[ORM\Column(name: 'remote_mode', enumType: RemoteMode::class, nullable: true)]
    private ?RemoteMode $remoteMode = null;

    #[ORM\Column(length: 255, nullable: true)]
    private ?string $remuneration = null;

    #[ORM\Column(name: 'offer_url', type: 'text', nullable: true)]
    private ?string $offerUrl = null;

    #[ORM\Column(type: 'text', nullable: true)]
    private ?string $notes = null;

    #[ORM\Column(name: 'application_date', nullable: true)]
    private ?DateTimeImmutable $applicationDate = null;

    #[ORM\Column(name: 'planned_follow_up_date', nullable: true)]
    private ?DateTimeImmutable $plannedFollowUpDate = null;

    #[ORM\Column(name: 'effective_follow_up_date', nullable: true)]
    private ?DateTimeImmutable $effectiveFollowUpDate = null;

    #[ORM\Column(name: 'first_contact_date', nullable: true)]
    private ?DateTimeImmutable $firstContactDate = null;

    #[ORM\Column(name: 'preliminary_interview_date', nullable: true)]
    private ?DateTimeImmutable $preliminaryInterviewDate = null;

    #[ORM\Column(name: 'second_interview_date', nullable: true)]
    private ?DateTimeImmutable $secondInterviewDate = null;

    #[ORM\Column(name: 'hr_contact_name', length: 255, nullable: true)]
    private ?string $hrContactName = null;

    #[ORM\Column(name: 'business_contact_name', length: 255, nullable: true)]
    private ?string $businessContactName = null;

    #[ORM\Column(name: 'subjective_relevance', nullable: true)]
    ...
    public function getOwner(): UserRecord
    {
        return $this->owner;
    }

    public function setOwner(UserRecord $owner): void
    {
        $this->owner = $owner;
    }
    ...
    public function setRemoteMode(?RemoteMode $remoteMode): void
    {
    ...
    public function setPlannedFollowUpDate(?DateTimeImmutable $plannedFollowUpDate): void
    {
        $this->plannedFollowUpDate = $plannedFollowUpDate;
    }
    ...
    public function setEffectiveFollowUpDate(?DateTimeImmutable $effectiveFollowUpDate): void
    {
    ...
    public function setFirstContactDate(?DateTimeImmutable $firstContactDate): void
    {
    ...
    public function setPreliminaryInterviewDate(?DateTimeImmutable $preliminaryInterviewDate): void
    {
    ...
    public function setSecondInterviewDate(?DateTimeImmutable $secondInterviewDate): void
    {
    ...
    public function setHrContactName(?string $hrContactName): void
    {
    ...
    public function setBusinessContactName(?string $businessContactName): void
    {
    ...
    public function setSubjectiveRelevance(?int $subjectiveRelevance): void
    {
    ...
    public function setStatus(TrackedJobStatus $status): void
    {
        $this->status = $status;
    }
