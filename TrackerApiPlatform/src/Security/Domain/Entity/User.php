...
/*
 * User aggregate used by authentication and administration use cases.
 * It owns profile, activation and role rules without depending on Symfony security or Doctrine records.
 */
...
final class User
{
    ...
    public function __construct(EmailAddress $email, ?DateTimeImmutable $createdAt = null)
    {
        $this->id = UserId::new();
        $this->email = $email;
